...
public class SNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    /* TODO: Implement me! */
    //cost = #lefttablepages + (#records/leftpage)*(lefttablepages)*(#righttablepages)
    TableStats right = getRightSource().getStats();
    TableStats left = getLeftSource().getStats();
    return left.getNumPages() + left.getNumRecords()*right.getNumPages();
    //(int) Math.ceil(left.getNumRecords()/left.getNumPages())*left.getNumPages()
  }
