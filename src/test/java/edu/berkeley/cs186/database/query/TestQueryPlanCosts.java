...
public class TestQueryPlanCosts {
  ...
  public void testBNLJ() throws DatabaseException, QueryPlanException {
  ...
  @Test
  @Category(StudentTestP4.class)
  public void testBNLJ2() throws DatabaseException, QueryPlanException {
    List<DataBox> values = TestUtils.createRecordWithAllTypes().getValues();
    this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable1");
    this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable2");
  ...
  @Test
  @Category(StudentTestP4.class)
  public void testLast() throws DatabaseException, QueryPlanException {
    List<DataBox> values = TestUtils.createRecordWithAllTypes().getValues();
    this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable1");
    this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable2");
  ...
  @Test
  @Category(StudentTestP4.class)
  public void testEstimateIO() throws DatabaseException, QueryPlanException {
    List<DataBox> values = TestUtils.createRecordWithAllTypes().getValues();
    this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable1");
    this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable2");
